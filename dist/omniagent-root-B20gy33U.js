...
//#endregion
//#region src/infra/omniagent-root.ts
const CORE_PACKAGE_NAMES = new Set(["omniagent", "omniorg"]);
...
async function resolveOmniAgentPackageRoot(opts) {
...
function resolveOmniAgentPackageRootSync(opts) {
	for (const candidate of buildCandidates(opts)) {
...
//#endregion
export { normalizeSkillFilter as i, resolveOmniAgentPackageRootSync as n, matchesSkillFilter as r, resolveOmniAgentPackageRoot as t };