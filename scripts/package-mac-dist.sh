...
# Output:
# - dist/OmniAgent.app
# - dist/OmniAgent-<version>.zip
# - dist/OmniAgent-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.omniagent.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/OmniAgent.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/OmniAgent-$VERSION.zip"
DMG="$ROOT_DIR/dist/OmniAgent-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/OmniAgent-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/OmniAgent-$VERSION.dSYM.zip"
