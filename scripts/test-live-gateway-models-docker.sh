...
docker run --rm -t \
  ...
  -e OMNIAGENT_LIVE_GATEWAY_MODELS="${OMNIAGENT_LIVE_GATEWAY_MODELS:-${CLAWDBOT_LIVE_GATEWAY_MODELS:-all}}" \
  -e OMNIAGENT_LIVE_GATEWAY_PROVIDERS="${OMNIAGENT_LIVE_GATEWAY_PROVIDERS:-${CLAWDBOT_LIVE_GATEWAY_PROVIDERS:-}}" \
  -e OMNIAGENT_LIVE_GATEWAY_MODEL_TIMEOUT_MS="${OMNIAGENT_LIVE_GATEWAY_MODEL_TIMEOUT_MS:-${CLAWDBOT_LIVE_GATEWAY_MODEL_TIMEOUT_MS:-}}" \
