...
if [[ -z "$version_content" ]]; then
  echo "<h2>OmniAgent $VERSION</h2>"
  echo "<p>Latest OmniAgent update.</p>"
  echo "<p><a href=\"https://github.com/Paparusi/omniagent/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
