import type { LineChannelData, OmniAgentPluginApi, ReplyPayload } from "omniagent/plugin-sdk";
import {
  createActionCard,
  createImageCard,
  createInfoCard,
...
export function registerLineCardCommand(api: OmniAgentPluginApi): void {
  api.registerCommand({
    name: "card",
