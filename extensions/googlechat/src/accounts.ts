...
export function listGoogleChatAccountIds(cfg: OmniAgentConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: OmniAgentConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: OmniAgentConfig): ResolvedGoogleChatAccount[] {
