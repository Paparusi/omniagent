...
- Version alignment with core OmniAgent release numbers.
...
- First public release of the @omniagent/voice-call plugin.
...
- CLI: `omniagent voicecall` commands (call/start/continue/speak/end/status/tail/expose).
