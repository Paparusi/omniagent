...
Nostr DM channel plugin for OmniAgent using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to OmniAgent. It enables your bot to:
...
# Configure omniagent to use local relay
