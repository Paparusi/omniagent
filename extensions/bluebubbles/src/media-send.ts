...
import { resolveChannelMediaMaxBytes, type OmniAgentConfig } from "omniagent/plugin-sdk";
...
function resolveMediaLocalRoots(params: { cfg: OmniAgentConfig; accountId?: string }): string[] {
