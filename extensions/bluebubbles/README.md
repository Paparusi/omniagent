...
This directory contains the **BlueBubbles external channel plugin** for OmniAgent.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `omniagent/plugin-sdk` helpers.
