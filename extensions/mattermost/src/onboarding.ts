import type { ChannelOnboardingAdapter, OmniAgentConfig, WizardPrompter } from "omniagent/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.omniagent.ai/channels/mattermost",
    ].join("\n"),
