...
export function listMattermostAccountIds(cfg: OmniAgentConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: OmniAgentConfig): string {
...
export function listEnabledMattermostAccounts(cfg: OmniAgentConfig): ResolvedMattermostAccount[] {
