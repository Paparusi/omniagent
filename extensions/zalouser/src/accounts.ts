...
export function listZalouserAccountIds(cfg: OmniAgentConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: OmniAgentConfig): string {
...
function mergeZalouserAccountConfig(cfg: OmniAgentConfig, accountId: string): ZalouserAccountConfig {
