...
describe("subtitleForTab", () => {
  ...
  it("returns descriptive subtitles", () => {
    ...
    expect(subtitleForTab("config")).toContain("omniagent.json");
  });
});
...
describe("normalizeBasePath", () => {
  it("normalizes base-path variants", () => {
    const cases = [
      ...
      { input: "/ui/", expected: "/ui" },
      { input: "/", expected: "" },
      { input: "/apps/omniagent", expected: "/apps/omniagent" },
    ] as const;
    for (const testCase of cases) {
...
describe("pathForTab", () => {
  it("builds tab paths with optional bases", () => {
    const cases = [
      ...
      { tab: "sessions", base: "/apps/omniagent", expected: "/apps/omniagent/sessions" },
    ] as const;
    for (const testCase of cases) {
      expect(
...
describe("tabFromPath", () => {
  it("resolves tabs from path variants", () => {
    const cases = [
      ...
      { path: "/apps/omniagent/sessions", base: "/apps/omniagent", expected: "sessions" },
...
describe("inferBasePathFromPathname", () => {
  it("infers base-path variants from pathname", () => {
    const cases = [
      ...
      { path: "/apps/omniagent/sessions", expected: "/apps/omniagent" },
