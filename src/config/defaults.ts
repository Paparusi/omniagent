...
function resolveAnthropicDefaultAuthMode(cfg: OmniAgentConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: OmniAgentConfig): OmniAgentConfig {
...
export function applyTalkApiKey(config: OmniAgentConfig): OmniAgentConfig {
...
export function applyModelDefaults(cfg: OmniAgentConfig): OmniAgentConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: OmniAgentConfig): OmniAgentConfig {
...
export function applyLoggingDefaults(cfg: OmniAgentConfig): OmniAgentConfig {
...
export function applyContextPruningDefaults(cfg: OmniAgentConfig): OmniAgentConfig {
...
export function applyCompactionDefaults(cfg: OmniAgentConfig): OmniAgentConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
