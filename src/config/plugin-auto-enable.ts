...
function isTelegramConfigured(cfg: OmniAgentConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: OmniAgentConfig, env: NodeJS.ProcessEnv): boolean {
...
function isIrcConfigured(cfg: OmniAgentConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: OmniAgentConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: OmniAgentConfig): boolean {
...
function isIMessageConfigured(cfg: OmniAgentConfig): boolean {
...
function isWhatsAppConfigured(cfg: OmniAgentConfig): boolean {
...
function isGenericChannelConfigured(cfg: OmniAgentConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: OmniAgentConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: OmniAgentConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: OmniAgentConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: OmniAgentConfig, pluginId: string): boolean {
...
function registerPluginEntry(cfg: OmniAgentConfig, pluginId: string): OmniAgentConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
