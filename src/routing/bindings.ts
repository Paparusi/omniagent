...
export function listBindings(cfg: OmniAgentConfig): AgentBinding[] {
...
export function listBoundAccountIds(cfg: OmniAgentConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: OmniAgentConfig) {
