...
function setSlackDmPolicy(cfg: OmniAgentConfig, dmPolicy: DmPolicy) {
...
function buildSlackManifest(botName: string) {
  const safeName = botName.trim() || "OmniAgent";
  const manifest = {
    display_information: {
      name: safeName,
      description: `${safeName} connector for OmniAgent`,
    },
    features: {
      bot_user: {
...
function setSlackAllowFrom(cfg: OmniAgentConfig, allowFrom: string[]): OmniAgentConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
