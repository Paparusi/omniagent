...
export function listChannelMessageActions(cfg: OmniAgentConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: OmniAgentConfig): boolean {
  for (const plugin of listChannelPlugins()) {
...
export function supportsChannelMessageCards(cfg: OmniAgentConfig): boolean {
  for (const plugin of listChannelPlugins()) {
