...
export type ChannelAgentToolFactory = (params: { cfg?: OmniAgentConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: OmniAgentConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: OmniAgentConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: OmniAgentConfig }) => boolean;
  supportsCards?: (params: { cfg: OmniAgentConfig }) => boolean;
