...
export type { OmniAgentConfig } from "../config/config.js";
/** @deprecated Use OmniAgentConfig instead */
export type { OmniAgentConfig as ClawdbotConfig } from "../config/config.js";
