...
import { type OmniAgentConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: OmniAgentConfig): string[] {
...
export function listAgentsForGateway(cfg: OmniAgentConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: OmniAgentConfig): string {
...
function resolveSessionStoreAgentId(cfg: OmniAgentConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: OmniAgentConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: OmniAgentConfig): GatewaySessionsDefaults {
