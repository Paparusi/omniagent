...
import type { OmniAgentConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: OmniAgentConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: OmniAgentConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: OmniAgentConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: OmniAgentConfig) => void;
  log: {
