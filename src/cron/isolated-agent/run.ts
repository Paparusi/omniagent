...
export type RunCronAgentTurnResult = {
   ...
   * messages.  See: https://github.com/Paparusi/omniagent/issues/15692
   */
  delivered?: boolean;
} & CronRunOutcome &
  CronRunTelemetry;
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  const isFastTestEnv = process.env.OMNIAGENT_TEST_FAST === "1";
  ...
  // correct per-agent paths (e.g. ~/.omniagent/agents/<agentId>/agent/).
  ...
  const cfgWithAgentDefaults: OmniAgentConfig = {
    ...params.cfg,
