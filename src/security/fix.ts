...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof OmniAgentConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: OmniAgentConfig; env: NodeJS.ProcessEnv }): {
  cfg: OmniAgentConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
