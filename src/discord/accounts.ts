...
function mergeDiscordAccountConfig(cfg: OmniAgentConfig, accountId: string): DiscordAccountConfig {
...
export function listEnabledDiscordAccounts(cfg: OmniAgentConfig): ResolvedDiscordAccount[] {
