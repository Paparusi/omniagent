...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.OMNIAGENT_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: OmniAgentConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: OmniAgentConfig): string {
...
function mergeTelegramAccountConfig(cfg: OmniAgentConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: OmniAgentConfig): ResolvedTelegramAccount[] {
