...
export function applyOpenrouterProviderConfig(cfg: OmniAgentConfig): OmniAgentConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyOpenrouterConfig(cfg: OmniAgentConfig): OmniAgentConfig {
  const next = applyOpenrouterProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, OPENROUTER_DEFAULT_MODEL_REF);
}

export function applyMoonshotProviderConfig(cfg: OmniAgentConfig): OmniAgentConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: OmniAgentConfig): OmniAgentConfig {
...
export function applyMoonshotConfig(cfg: OmniAgentConfig): OmniAgentConfig {
  const next = applyMoonshotProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyMoonshotConfigCn(cfg: OmniAgentConfig): OmniAgentConfig {
  const next = applyMoonshotProviderConfigCn(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyKimiCodeProviderConfig(cfg: OmniAgentConfig): OmniAgentConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: OmniAgentConfig): OmniAgentConfig {
  const next = applyKimiCodeProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, KIMI_CODING_MODEL_REF);
}

export function applySyntheticProviderConfig(cfg: OmniAgentConfig): OmniAgentConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: OmniAgentConfig): OmniAgentConfig {
  const next = applySyntheticProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, SYNTHETIC_DEFAULT_MODEL_REF);
}

export function applyXiaomiProviderConfig(cfg: OmniAgentConfig): OmniAgentConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: OmniAgentConfig): OmniAgentConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: OmniAgentConfig): OmniAgentConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: OmniAgentConfig): OmniAgentConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: OmniAgentConfig): OmniAgentConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: OmniAgentConfig): OmniAgentConfig {
 ...
 */
export function applyHuggingfaceProviderConfig(cfg: OmniAgentConfig): OmniAgentConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyHuggingfaceConfig(cfg: OmniAgentConfig): OmniAgentConfig {
  const next = applyHuggingfaceProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, HUGGINGFACE_DEFAULT_MODEL_REF);
}

export function applyXaiProviderConfig(cfg: OmniAgentConfig): OmniAgentConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: OmniAgentConfig): OmniAgentConfig {
...
export function applyQianfanProviderConfig(cfg: OmniAgentConfig): OmniAgentConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: OmniAgentConfig): OmniAgentConfig {
