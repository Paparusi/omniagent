...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.omniagent.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("omniagent hooks list")}`,
      `  ${formatCliCommand("omniagent hooks enable <name>")}`,
      `  ${formatCliCommand("omniagent hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
