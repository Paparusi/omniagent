...
export function applyVercelAiGatewayProviderConfig(cfg: OmniAgentConfig): OmniAgentConfig {
...
export function applyVercelAiGatewayConfig(cfg: OmniAgentConfig): OmniAgentConfig {
