...
type PromptDefaultModelResult = { model?: string; config?: OmniAgentConfig };
...
function resolveConfiguredModelRaw(cfg: OmniAgentConfig): string {
...
function resolveConfiguredModelKeys(cfg: OmniAgentConfig): string[] {
...
export function applyPrimaryModel(cfg: OmniAgentConfig, model: string): OmniAgentConfig {
...
export function applyModelAllowlist(cfg: OmniAgentConfig, models: string[]): OmniAgentConfig {
  const defaults = cfg.agents?.defaults;
