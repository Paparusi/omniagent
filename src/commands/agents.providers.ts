...
function resolveDefaultAccountId(cfg: OmniAgentConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: OmniAgentConfig): boolean {
...
export function summarizeBindings(cfg: OmniAgentConfig, bindings: AgentBinding[]): string[] {
