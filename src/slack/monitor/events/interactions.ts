...
// Prefix for OmniAgent-generated action IDs to scope our handler
const OMNIAGENT_ACTION_PREFIX = "omniagent:";
...
export function registerSlackInteractionEvents(params: { ctx: SlackMonitorContext }) {
  ...
  // Handle OmniAgent modal submissions with callback_ids scoped by our prefix.
  ctx.app.view(
    new RegExp(`^${OMNIAGENT_ACTION_PREFIX}`),
