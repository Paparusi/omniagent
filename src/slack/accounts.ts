...
function mergeSlackAccountConfig(cfg: OmniAgentConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: OmniAgentConfig): ResolvedSlackAccount[] {
