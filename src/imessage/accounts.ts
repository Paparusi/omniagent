...
function mergeIMessageAccountConfig(cfg: OmniAgentConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: OmniAgentConfig): ResolvedIMessageAccount[] {
