...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@omniagent", { botUsername: "omniagent" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@omniagent args", {
        botUsername: "omniagent",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@omniagent: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "omniagent" })).toBe(
      "/help@otherbot",
    );
  });
