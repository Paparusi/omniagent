...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.omniagent.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", OMNIAGENT_PROFILE: "default" },
    });
...
describe("launchd bootstrap repair", () => {
  it("bootstraps and kickstarts the resolved label", async () => {
    ...
    const label = "ai.omniagent.gateway";
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.omniagent.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when OMNIAGENT_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.omniagent.gateway.plist",
    },
    {
      name: "uses profile-specific label when OMNIAGENT_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", OMNIAGENT_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.omniagent.jbphoenix.plist",
    },
    {
      name: "prefers OMNIAGENT_LAUNCHD_LABEL over OMNIAGENT_PROFILE",
      env: {
        HOME: "/Users/test",
        OMNIAGENT_PROFILE: "jbphoenix",
        OMNIAGENT_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from OMNIAGENT_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        OMNIAGENT_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty OMNIAGENT_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        OMNIAGENT_PROFILE: "myprofile",
        OMNIAGENT_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.omniagent.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
