...
export const A2UI_PATH = "/__omniagent__/a2ui";

export const CANVAS_HOST_PATH = "/__omniagent__/canvas";

export const CANVAS_WS_PATH = "/__omniagent__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.omniagentCanvasA2UIAction.postMessage(...)
  // - Android: window.omniagentCanvasA2UIAction.postMessage(...)
  const handlerNames = ["omniagentCanvasA2UIAction"];
  ...
  globalThis.OmniAgent = globalThis.OmniAgent ?? {};
  globalThis.OmniAgent.postMessage = postToNode;
  globalThis.OmniAgent.sendUserAction = sendUserAction;
  globalThis.omniagentPostMessage = postToNode;
  globalThis.omniagentSendUserAction = sendUserAction;
