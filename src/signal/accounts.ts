...
function mergeSignalAccountConfig(cfg: OmniAgentConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: OmniAgentConfig): ResolvedSignalAccount[] {
