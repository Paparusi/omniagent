...
const SANDBOX_EXAMPLES = {
  main: [
    ["omniagent sandbox list", "List all sandbox containers."],
    ["omniagent sandbox list --browser", "List only browser containers."],
    ["omniagent sandbox recreate --all", "Recreate all containers."],
    ["omniagent sandbox recreate --session main", "Recreate a specific session."],
    ["omniagent sandbox recreate --agent mybot", "Recreate agent containers."],
    ["omniagent sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["omniagent sandbox list", "List all sandbox containers."],
    ["omniagent sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["omniagent sandbox recreate --all", "Recreate all containers."],
    ["omniagent sandbox recreate --session main", "Recreate a specific session."],
    ["omniagent sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["omniagent sandbox recreate --browser --all", "Recreate only browser containers."],
    ["omniagent sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["omniagent sandbox explain", "Show effective sandbox config."],
    ["omniagent sandbox explain --session agent:main:main", "Explain a specific session."],
    ["omniagent sandbox explain --agent work", "Explain an agent sandbox."],
    ["omniagent sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.omniagent.ai/cli/sandbox")}\n`,
    )
    .action(() => {
