    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["omniagent directory self --channel slack", "Show the connected account identity."],
          [
            'omniagent directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["omniagent directory groups list --channel discord", "List available groups/channels."],
          [
            "omniagent directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.omniagent.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
