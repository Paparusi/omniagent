    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["omniagent channels list", "List configured channels and auth profiles."],
          ["omniagent channels status --probe", "Run channel status checks and probes."],
          [
            "omniagent channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["omniagent channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.omniagent.ai/cli/channels",
        )}\n`,
    );
