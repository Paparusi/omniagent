...
const shouldRegisterPrimaryOnly = (argv: string[]) => {
  if (isTruthyEnvValue(process.env.OMNIAGENT_DISABLE_LAZY_SUBCOMMANDS)) {
    return false;
  }
...
const shouldEagerRegisterSubcommands = (_argv: string[]) => {
  return isTruthyEnvValue(process.env.OMNIAGENT_DISABLE_LAZY_SUBCOMMANDS);
};

const loadConfig = async (): Promise<OmniAgentConfig> => {
...
const entries: SubCliEntry[] = [
  ...
  {
    name: "docs",
    description: "Search the live OmniAgent docs",
    hasSubcommands: false,
    register: async (program) => {
  ...
  {
    name: "plugins",
    description: "Manage OmniAgent plugins and extensions",
    hasSubcommands: true,
    register: async (program) => {
