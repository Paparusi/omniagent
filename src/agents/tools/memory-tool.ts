...
function resolveMemoryToolContext(options: { config?: OmniAgentConfig; agentSessionKey?: string }) {
...
function resolveMemoryCitationsMode(cfg: OmniAgentConfig): MemoryCitationsMode {
