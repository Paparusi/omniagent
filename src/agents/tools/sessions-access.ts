...
export function resolveSessionToolsVisibility(cfg: OmniAgentConfig): SessionToolsVisibility {
...
export function resolveSandboxSessionToolsVisibility(cfg: OmniAgentConfig): "spawned" | "all" {
...
export function createAgentToAgentPolicy(cfg: OmniAgentConfig): AgentToAgentPolicy {
