...
function resolveWatchPaths(workspaceDir: string, config?: OmniAgentConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: OmniAgentConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: OmniAgentConfig }) {
