...
function makeCfg(overrides: Partial<OmniAgentConfig> = {}): OmniAgentConfig {
  return {
    agents: {
      defaults: {
        model: {
...
function makeFallbacksOnlyCfg(): OmniAgentConfig {
  return {
    agents: {
      defaults: {
        model: {
...
function makeProviderFallbackCfg(provider: string): OmniAgentConfig {
  return makeCfg({
    agents: {
      defaults: {
        model: {
