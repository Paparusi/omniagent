...
function resolveAvatarSource(cfg: OmniAgentConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: OmniAgentConfig, agentId: string): AgentAvatarResolution {
