...
const CLEANUP_STATE_KEY = Symbol.for("omniagent.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("omniagent.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("omniagent.sessionWriteLockWatchdogState");
