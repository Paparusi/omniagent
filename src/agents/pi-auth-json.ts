...
/**
 * Convert an OmniAgent auth-profiles credential to pi-coding-agent auth.json format.
 ...
 *
 * OmniAgent stores credentials in auth-profiles.json instead. This helper
