...
function resolveAdaptiveReadMaxBytes(options?: OmniAgentReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createOmniAgentReadTool(base, {
...
export function createOmniAgentReadTool(
  base: AnyAgentTool,
  options?: OmniAgentReadToolOptions,
): AnyAgentTool {
