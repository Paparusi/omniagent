...
export const DEFAULT_SANDBOX_IMAGE = "omniagent-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "omniagent-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "omniagent-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "omniagent-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-21-novnc-auth-default";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "omniagent-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "omniagent-sandbox-browser";
