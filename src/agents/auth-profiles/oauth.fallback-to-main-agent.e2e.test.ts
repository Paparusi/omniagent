...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveOmniAgentAgentDir() returns mainAgentDir
    process.env.OMNIAGENT_STATE_DIR = tmpDir;
    process.env.OMNIAGENT_AGENT_DIR = mainAgentDir;
