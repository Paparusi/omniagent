...
function resolveGatewayPort(cfg: OmniAgentConfig, env: NodeJS.ProcessEnv): number {
...
function resolveAuth(cfg: OmniAgentConfig, env: NodeJS.ProcessEnv): ResolveAuthResult {
  ...
  const password =
    env.OMNIAGENT_GATEWAY_PASSWORD?.trim() ||
