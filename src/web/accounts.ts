...
export function listWhatsAppAuthDirs(cfg: OmniAgentConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: OmniAgentConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: OmniAgentConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: OmniAgentConfig): ResolvedWhatsAppAccount[] {
