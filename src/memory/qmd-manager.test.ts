...
describe("QmdMemoryManager", () => {
  ...
  let stateDir: string;
  let cfg: OmniAgentConfig;
  const agentId = "main";

  async function createManager(params?: { mode?: "full" | "status"; cfg?: OmniAgentConfig }) {
  ...
  afterEach(async () => {
    ...
    delete (globalThis as Record<string, unknown>).__omniagentMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__omniagentMcporterColdStartWarned;
  });
