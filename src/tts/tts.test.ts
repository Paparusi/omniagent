...
describe("tts", () => {
  ...
  describe("maybeApplyTtsToPayload", () => {
    ...
    const withMockedAutoTtsFetch = async (
      ...
      const prevPrefs = process.env.OMNIAGENT_TTS_PREFS;
      process.env.OMNIAGENT_TTS_PREFS = `/tmp/tts-test-${Date.now()}.json`;
      ...
      try {
        ...
        process.env.OMNIAGENT_TTS_PREFS = prevPrefs;
      }
    };

    const taggedCfg: OmniAgentConfig = {
      ...baseCfg,
      messages: {
        ...baseCfg.messages!,
