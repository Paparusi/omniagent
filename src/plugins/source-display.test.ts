...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/omniagent/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/omniagent/extensions",
        global: "/Users/x/.omniagent/extensions",
        workspace: "/Users/x/ws/.omniagent/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.omniagent/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/omniagent/extensions",
        global: "/Users/x/.omniagent/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.omniagent/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/omniagent/extensions",
        global: "/Users/x/.omniagent/extensions",
