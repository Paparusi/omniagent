...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @omniagent/voice-call -> voice-call).
...
export function discoverOmniAgentPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ownershipUid?: number | null;
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".omniagent", "extensions")];
