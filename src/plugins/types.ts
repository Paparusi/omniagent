...
export type OmniAgentPluginConfigSchema = {
...
export type OmniAgentPluginToolContext = {
...
export type OmniAgentPluginToolFactory = (
  ctx: OmniAgentPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type OmniAgentPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type OmniAgentPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
...
export type ProviderAuthResult = {
  ...
  configPatch?: Partial<OmniAgentConfig>;
  defaultModel?: string;
  notes?: string[];
};
...
export type OmniAgentPluginGatewayMethod = {
  method: string;
...
export type PluginCommandContext = {
  ...
  commandBody: string;
  /** Current OmniAgent configuration */
  config: OmniAgentConfig;
 ...
 */
export type OmniAgentPluginCommandDefinition = {
...
export type OmniAgentPluginHttpHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<boolean> | boolean;

export type OmniAgentPluginHttpRouteHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<void> | void;

export type OmniAgentPluginCliContext = {
  program: Command;
  config: OmniAgentConfig;
  workspaceDir?: string;
  logger: PluginLogger;
...
export type OmniAgentPluginCliRegistrar = (ctx: OmniAgentPluginCliContext) => void | Promise<void>;

export type OmniAgentPluginServiceContext = {
  config: OmniAgentConfig;
  workspaceDir?: string;
  stateDir: string;
  logger: PluginLogger;
...
export type OmniAgentPluginService = {
  id: string;
  start: (ctx: OmniAgentPluginServiceContext) => void | Promise<void>;
  stop?: (ctx: OmniAgentPluginServiceContext) => void | Promise<void>;
};

export type OmniAgentPluginChannelRegistration = {
  plugin: ChannelPlugin;
  dock?: ChannelDock;
};

export type OmniAgentPluginDefinition = {
  id?: string;
  name?: string;
  description?: string;
  version?: string;
  kind?: PluginKind;
  configSchema?: OmniAgentPluginConfigSchema;
  register?: (api: OmniAgentPluginApi) => void | Promise<void>;
  activate?: (api: OmniAgentPluginApi) => void | Promise<void>;
};

export type OmniAgentPluginModule =
  | OmniAgentPluginDefinition
  | ((api: OmniAgentPluginApi) => void | Promise<void>);

export type OmniAgentPluginApi = {
  id: string;
  name: string;
  version?: string;
  description?: string;
  ...
  logger: PluginLogger;
  registerTool: (
    tool: AnyAgentTool | OmniAgentPluginToolFactory,
    opts?: OmniAgentPluginToolOptions,
  ) => void;
  registerHook: (
    events: string | string[],
    handler: InternalHookHandler,
    opts?: OmniAgentPluginHookOptions,
  ) => void;
  registerHttpHandler: (handler: OmniAgentPluginHttpHandler) => void;
  registerHttpRoute: (params: { path: string; handler: OmniAgentPluginHttpRouteHandler }) => void;
  registerChannel: (registration: OmniAgentPluginChannelRegistration | ChannelPlugin) => void;
  registerGatewayMethod: (method: string, handler: GatewayRequestHandler) => void;
  registerCli: (registrar: OmniAgentPluginCliRegistrar, opts?: { commands?: string[] }) => void;
  registerService: (service: OmniAgentPluginService) => void;
   ...
   */
  registerCommand: (command: OmniAgentPluginCommandDefinition) => void;
