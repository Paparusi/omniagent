...
export const normalizePluginsConfig = (
  config?: OmniAgentConfig["plugins"],
...
const hasExplicitMemorySlot = (plugins?: OmniAgentConfig["plugins"]) =>
  Boolean(plugins?.slots && Object.prototype.hasOwnProperty.call(plugins.slots, "memory"));

const hasExplicitMemoryEntry = (plugins?: OmniAgentConfig["plugins"]) =>
  Boolean(plugins?.entries && Object.prototype.hasOwnProperty.call(plugins.entries, "memory-core"));

const hasExplicitPluginConfig = (plugins?: OmniAgentConfig["plugins"]) => {
  if (!plugins) {
    return false;
  }
