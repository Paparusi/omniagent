...
describe("loader", () => {
  ...
  beforeAll(async () => {
    fixtureRoot = await fs.mkdtemp(path.join(os.tmpdir(), "omniagent-hooks-loader-"));
  });
  ...
  beforeEach(async () => {
    ...
    envSnapshot = captureEnv(["OMNIAGENT_BUNDLED_HOOKS_DIR"]);
    process.env.OMNIAGENT_BUNDLED_HOOKS_DIR = "/nonexistent/bundled/hooks";
  });
