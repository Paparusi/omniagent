...
import type { OmniAgentPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: OmniAgentPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: OmniAgentPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
