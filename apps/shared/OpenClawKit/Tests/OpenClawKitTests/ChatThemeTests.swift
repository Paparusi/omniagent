...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = OmniAgentChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = OmniAgentChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
