...
@MainActor
public struct OmniAgentChatView: View {
    public enum Style {
        case standard
        case onboarding
    }
    ...
    public init(
        viewModel: OmniAgentChatViewModel,
    ...
    private var visibleMessages: [OmniAgentChatMessage] {
        let base: [OmniAgentChatMessage]
    ...
    private func mergeToolResults(in messages: [OmniAgentChatMessage]) -> [OmniAgentChatMessage] {
        ...
        for message in messages {
            ...
            let merged = OmniAgentChatMessage(
                id: last.id,
                role: last.role,
                content: content,
    ...
    private func isToolResultMessage(_ message: OmniAgentChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: OmniAgentChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: OmniAgentChatMessage) -> String {
