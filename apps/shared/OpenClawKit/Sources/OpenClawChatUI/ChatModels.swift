...
public typealias OmniAgentPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias OmniAgentPlatformImage = UIImage
#endif

public struct OmniAgentChatUsageCost: Codable, Hashable, Sendable {
...
public struct OmniAgentChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: OmniAgentChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(OmniAgentChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct OmniAgentChatMessageContent: Codable, Hashable, Sendable {
...
public struct OmniAgentChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [OmniAgentChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: OmniAgentChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [OmniAgentChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: OmniAgentChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(OmniAgentChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([OmniAgentChatMessageContent].self, forKey: .content) {
...
public struct OmniAgentChatHistoryPayload: Codable, Sendable {
...
public struct OmniAgentSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct OmniAgentSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [OmniAgentSessionPreviewItem]
}

public struct OmniAgentSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [OmniAgentSessionPreviewEntry]

    public init(ts: Int, previews: [OmniAgentSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct OmniAgentChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct OmniAgentChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct OmniAgentAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct OmniAgentChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct OmniAgentGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct OmniAgentPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: OmniAgentPlatformImage?
    ...
    public init(
        ...
        mimeType: String,
        type: String = "file",
        preview: OmniAgentPlatformImage?)
    {
        self.url = url
        self.data = data
        self.fileName = fileName
...
public struct OmniAgentChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
