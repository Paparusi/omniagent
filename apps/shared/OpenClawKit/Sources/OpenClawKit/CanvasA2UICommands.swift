...
public enum OmniAgentCanvasA2UICommand: String, Codable, Sendable {
...
public struct OmniAgentCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct OmniAgentCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
