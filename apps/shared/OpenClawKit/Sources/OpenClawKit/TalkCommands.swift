...
public enum OmniAgentTalkCommand: String, Codable, Sendable {
...
public struct OmniAgentTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct OmniAgentTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
