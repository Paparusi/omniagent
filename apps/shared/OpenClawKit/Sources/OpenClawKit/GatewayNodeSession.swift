...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.omniagent", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.omniagent", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: OmniAgentProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
