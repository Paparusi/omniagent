...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = OmniAgentConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = OmniAgentConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = OmniAgentConfigFile.loadDict()
            ...
            OmniAgentConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/omniagent"
        state.remoteCliPath = ""
        return state
    }
}
