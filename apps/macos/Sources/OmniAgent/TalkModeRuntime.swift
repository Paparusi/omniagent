...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.omniagent", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.omniagent", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [OmniAgentChatMessage] = messages.compactMap { item in
