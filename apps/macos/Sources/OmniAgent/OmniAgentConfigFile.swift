...
enum OmniAgentConfigFile {
    private static let logger = Logger(subsystem: "ai.omniagent", category: "config")
    ...
    static func stateDirURL() -> URL {
        OmniAgentPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        OmniAgentPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-omniagent-config-file",
            "event": "config.write",
