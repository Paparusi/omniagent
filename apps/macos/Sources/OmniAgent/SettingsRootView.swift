...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .omniagentSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? OmniAgentPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? OmniAgentPaths.stateDirURL.path
...
extension Notification.Name {
    static let omniagentSelectSettingsTab = Notification.Name("omniagentSelectSettingsTab")
}
