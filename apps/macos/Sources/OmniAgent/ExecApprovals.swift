...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.omniagent", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        OmniAgentPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        OmniAgentPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
