...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.omniagent", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("OmniAgent/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__omniagent__/a2ui/").absoluteString + "?platform=macos"
    }
