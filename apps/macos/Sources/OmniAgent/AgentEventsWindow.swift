...
private struct EventRow: View {
    ...
    private func prettyJSON(_ dict: [String: OmniAgentProtocol.AnyCodable]) -> String? {
...
struct AgentEventsWindow_Previews: PreviewProvider {
    static var previews: some View {
        let sample = ControlAgentEvent(
            ...
            data: [
                "phase": OmniAgentProtocol.AnyCodable("start"),
                "name": OmniAgentProtocol.AnyCodable("bash"),
            ],
            summary: nil)
