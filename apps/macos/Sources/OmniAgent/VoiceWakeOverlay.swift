...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.omniagent", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other OmniAgent windows, but below the system’s pop-up menus.
