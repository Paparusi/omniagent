...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/Paparusi/omniagent") {
            ...
            VStack(alignment: .center, spacing: 6) {
                ...
                AboutLinkRow(icon: "globe", title: "Website", url: "https://omniagent.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "OmniAgentBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "OmniAgentBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "OmniAgentGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "OmniAgentGitCommit") as? String) ??
            "unknown"
    }
