...
enum UIStrings {
    static let welcomeTitle = "Welcome to OmniAgent"
}
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: OmniAgentOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: OmniAgentChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g omniagent@\(version)"
    }
