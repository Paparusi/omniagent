...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.omniagent", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return OmniAgentConfigFile.defaultWorkspaceURL() }
