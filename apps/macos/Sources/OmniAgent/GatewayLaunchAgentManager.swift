...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.omniagent", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".omniagent/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.omniagentCommand(
            subcommand: "gateway",
