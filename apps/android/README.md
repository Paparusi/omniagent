## OmniAgent Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_omniagent-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm omniagent gateway --port 18789 --verbose
```
