...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.omniagent.gateway"
    private static let nodeService = "ai.omniagent.node"
    private static let talkService = "ai.omniagent.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.omniagent.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.omniagent.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first?
            .appendingPathComponent("omniagent-gateway.log")
    }
