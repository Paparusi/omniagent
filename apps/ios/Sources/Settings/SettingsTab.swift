...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = OmniAgentLocationMode.off.rawValue
    ...
    @State private var lastLocationModeRaw: String = OmniAgentLocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "ai.omniagent.ios", category: "GatewaySettings")
    ...
    var body: some View {
        NavigationStack {
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        self.featureToggle(
                            ...
                            help: "Enables voice conversation mode with your connected OmniAgent agent.") { newValue in
                        ...
                        self.featureToggle(
                            ...
                            help: "Allows the gateway to request photos or short video clips while OmniAgent is foregrounded.")
                        ...
                        HStack(spacing: 8) {
                            ...
                            Button {
                                self.activeFeatureHelp = FeatureHelp(
                                    ...
                                    message: "Controls location permissions for OmniAgent. Off disables location tools, While Using enables foreground location, and Always enables background location.")
                            } label: {
                        ...
                        Picker("Location Access", selection: self.$locationEnabledModeRaw) {
                            Text("Off").tag(OmniAgentLocationMode.off.rawValue)
                            Text("While Using").tag(OmniAgentLocationMode.whileUsing.rawValue)
                            Text("Always").tag(OmniAgentLocationMode.always.rawValue)
                        }
                        .labelsHidden()
                        ...
                        self.featureToggle(
                            ...
                            help: "Keeps the screen awake while OmniAgent is open.")
                            ...
                            HStack(spacing: 8) {
                                ...
                                Button {
                                    self.activeFeatureHelp = FeatureHelp(
                                        ...
                                        message: "Appends this instruction when sharing content into OmniAgent from iOS.")
                                } label: {
                                    Image(systemName: "info.circle")
                                        .foregroundStyle(.secondary)
                                }
                    ...
                    DisclosureGroup("Device Info") {
                        ...
                        LabeledContent("OmniAgent", value: self.omniAgentVersionString())
                    }
                }
            }
            ...
            .onChange(of: self.locationEnabledModeRaw) { _, newValue in
                ...
                guard let mode = OmniAgentLocationMode(rawValue: newValue) else { return }
                Task {
    ...
    private func omniAgentVersionString() -> String {
