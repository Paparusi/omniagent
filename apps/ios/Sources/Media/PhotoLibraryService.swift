...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: OmniAgentPhotosLatestParams) async throws -> OmniAgentPhotosLatestPayload {
        ...
        var results: [OmniAgentPhotoPayload] = []
        ...
        return OmniAgentPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> OmniAgentPhotoPayload
    {
