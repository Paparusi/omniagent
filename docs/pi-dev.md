...
This guide summarizes a sane workflow for working on the pi integration in OmniAgent.
...
- Trigger the agent directly:
  - `pnpm omniagent agent --message "Hello" --thinking low`
...
State lives under the OmniAgent state directory. Default is `~/.omniagent`. If `OMNIAGENT_STATE_DIR` is set, use that directory instead.

To reset everything:

- `omniagent.json` for config
...
- [https://docs.omniagent.ai/testing](https://docs.omniagent.ai/testing)
- [https://docs.omniagent.ai/start/getting-started](https://docs.omniagent.ai/start/getting-started)
