...
OmniAgent treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.omniagent/settings/voicewake.json`

Shape:

```json
{ "triggers": ["omniagent", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
