---
summary: "Overview of OmniAgent onboarding options and flows"
read_when:
...
OmniAgent supports multiple onboarding paths depending on where the Gateway runs
...
- [`omniagent onboard` command](/cli/onboard)

## macOS app onboarding

Use the OmniAgent app when you want a fully guided setup on macOS. Docs:
