---
summary: "First-run onboarding flow for OmniAgent (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give OmniAgent">
...
<Step title="CLI">
  ...
  The app can install the global `omniagent` CLI via npm/pnpm so terminal
