...
You can point OmniAgent at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or OmniAgent
...
- [Anthropic provider](/providers/anthropic) - Native OmniAgent integration with Claude setup-token or API keys
