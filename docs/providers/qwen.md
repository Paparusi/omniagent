---
summary: "Use Qwen OAuth (free tier) in OmniAgent"
read_when:
  - You want to use Qwen with OmniAgent
...
If you already logged in with the Qwen Code CLI, OmniAgent will sync credentials
