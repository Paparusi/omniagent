---
summary: "Use Qianfan's unified API to access many models in OmniAgent"
read_when:
...
3. OmniAgent installed on your system
...
4. Copy the API key for use with OmniAgent

## CLI setup

```bash
omniagent onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [OmniAgent Configuration](/gateway/configuration)
