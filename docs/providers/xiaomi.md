---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with OmniAgent"
read_when:
  - You want Xiaomi MiMo models in OmniAgent
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). OmniAgent uses
