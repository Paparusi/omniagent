---
summary: "Use NVIDIA's OpenAI-compatible API in OmniAgent"
read_when:
  - You want to use NVIDIA models in OmniAgent
...
omniagent onboard --auth-choice skip
omniagent models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
