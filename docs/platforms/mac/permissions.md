...
- Same path: run the app from a fixed location (for OmniAgent, `dist/OmniAgent.app`).
...
Workaround: move files into the OmniAgent workspace (`~/.omniagent/workspace`) if you want to avoid per-folder grants.
