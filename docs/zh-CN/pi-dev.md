...
本指南总结了在 OmniAgent 中开发 Pi 集成的合理工作流程。
...
状态存储在 OmniAgent 状态目录下。默认为 `~/.omniagent`。如果设置了 `OMNIAGENT_STATE_DIR`，则使用该目录。
...
- https://docs.omniagent.ai/testing
- https://docs.omniagent.ai/start/getting-started
