...
- 生成的 Swift 模型：`apps/macos/Sources/OmniAgentProtocol/GatewayModels.swift`
...
- https://raw.githubusercontent.com/omniagent/omniagent/main/dist/protocol.schema.json
