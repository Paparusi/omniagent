...
read_when:
  - You want OmniAgent to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables OmniAgent to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`omniagent onboard`) and `omniagent channels add` list optional channel plugins.
...
```bash
omniagent plugins install @omniagent/nostr
```

Use a local checkout (dev workflows):

```bash
omniagent plugins install --link <path-to-omniagent>/extensions/nostr
```
...
```json
{
  "channels": {
    "nostr": {
      ...
      "profile": {
        "name": "omniagent",
        "displayName": "OmniAgent",
        "about": "Personal assistant DM bot",
        "picture": "https://example.com/avatar.png",
        "banner": "https://example.com/banner.png",
        "website": "https://example.com",
        "nip05": "omniagent@example.com",
        "lud16": "omniagent@example.com"
      }
    }
  }
}
