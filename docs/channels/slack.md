...
```
  ...
  <Tab title="HTTP Events API mode">
    <Steps>
      ...
      <Step title="Configure OmniAgent HTTP mode">
...
<Tabs>
  <Tab title="DM policy">
    ...
    Pairing in DMs uses `omniagent pairing approve slack <code>`.
...
OmniAgent supports Slack native text streaming via the Agents and AI Apps API.
...
- If streaming fails mid-reply, OmniAgent falls back to normal delivery for remaining payloads.
