...
- Install via CLI: `omniagent plugins install @omniagent/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `omniagent plugins install ./extensions/zalo`
   - From npm (if published): `omniagent plugins install @omniagent/zalo`
...
- Approve via:
  - `omniagent pairing list zalo`
  - `omniagent pairing approve zalo <CODE>`
...
- Example: `omniagent message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `omniagent channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `omniagent logs --follow`
