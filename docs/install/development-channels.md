...
OmniAgent ships three update channels:
...
When you **explicitly** switch channels with `--channel`, OmniAgent also aligns
the install method:
...
When you switch channels with `omniagent update`, OmniAgent also syncs plugin sources:
