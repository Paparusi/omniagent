...
omniagent system heartbeat last
omniagent logs --follow
omniagent config get agents.defaults.heartbeat
omniagent channels status --probe
```
...
```bash
omniagent config get agents.defaults.heartbeat.activeHours
omniagent config get agents.defaults.heartbeat.activeHours.timezone
omniagent config get agents.defaults.userTimezone || echo "agents.defaults.userTimezone not set"
omniagent cron list
omniagent logs --follow
```
