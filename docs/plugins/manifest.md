...
read_when:
  - You are building a OmniAgent plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (omniagent.plugin.json)

Every plugin **must** ship a `omniagent.plugin.json` file in the **plugin root**.
OmniAgent uses this manifest to validate configuration **without executing plugin
