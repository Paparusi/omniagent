...
read_when:
  - You want to publish a third-party OmniAgent plugin
...
This page tracks high-quality **community-maintained plugins** for OmniAgent.

We accept PRs that add community plugins here when they meet the quality bar.

## Required for listing

- Plugin package is published on npmjs (installable via `omniagent plugins install <npm-spec>`).
...
- **Plugin Name** — short description
  ...
  install: `omniagent plugins install @scope/package`
